...
group_desc_dict = {'All': f"All unique tickers/symbols included in this app",
                   ...
                   'ARK Innovation ETF': f"Basket Holdings: <b>{len(ARK_df_dict['ARKK'].index)}</b><br/>" + ARK_df_dict['ARKK'][['ticker','company','shares','weight(%)']].reset_index(drop=True).to_html(index=True,formatters={'shares':'{:,.0f}'.format}),
                   'ARK Autonomous Tech. & Robotics ETF': f"Basket Holdings: <b>{len(ARK_df_dict['ARKQ'].index)}</b><br/>" + ARK_df_dict['ARKQ'][['ticker','company','shares','weight(%)']].reset_index(drop=True).to_html(index=True,formatters={'shares':'{:,.0f}'.format}),
                   'ARK Next Generation Internet ETF': f"Basket Holdings: <b>{len(ARK_df_dict['ARKW'].index)}</b><br/>" + ARK_df_dict['ARKW'][['ticker','company','shares','weight(%)']].reset_index(drop=True).to_html(index=True,formatters={'shares':'{:,.0f}'.format}),
                   'ARK Genomic Revolution ETF': f"Basket Holdings: <b>{len(ARK_df_dict['ARKG'].index)}</b><br/>" + ARK_df_dict['ARKG'][['ticker','company','shares','weight(%)']].reset_index(drop=True).to_html(index=True,formatters={'shares':'{:,.0f}'.format}),
                   'ARK Fintech Innovation ETF': f"Basket Holdings: <b>{len(ARK_df_dict['ARKF'].index)}</b><br/>" + ARK_df_dict['ARKF'][['ticker','company','shares','weight(%)']].reset_index(drop=True).to_html(index=True,formatters={'shares':'{:,.0f}'.format}),
                   'ARK Space Exploration & Innovation ETF': f"Basket Holdings: <b>{len(ARK_df_dict['ARKX'].index)}</b><br/>" + ARK_df_dict['ARKX'][['ticker','company','shares','weight(%)']].reset_index(drop=True).to_html(index=True,formatters={'shares':'{:,.0f}'.format}),
                   'ARK The 3D Printing ETF': f"Basket Holdings: <b>{len(ARK_df_dict['PRNT'].index)}</b><br/>" + ARK_df_dict['PRNT'][['ticker','company','shares','weight(%)']].reset_index(drop=True).to_html(index=True,formatters={'shares':'{:,.0f}'.format}),
                   'ARK Israel Innovative Technology ETF': f"Basket Holdings: <b>{len(ARK_df_dict['IZRL'].index)}</b><br/>" + ARK_df_dict['IZRL'][['ticker','company','shares','weight(%)']].reset_index(drop=True).to_html(index=True,formatters={'shares':'{:,.0f}'.format}),
                   'Others': f"Others"}
